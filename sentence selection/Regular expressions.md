...
rechtshandelingen = {
    ...
    'opheffen': (
        ...
        r'|\bword(?:t)\d*(?:\s+\w+)*?\s+opgehev' # wordt ... opgelegd
    ),
    'opschorten': (
        r'\schort\b(?:\s+\w+)*?\s+op\d*\b'
        r'|\bop\s+te\s+schorten\d*\b'
        r'|\bword(?:t)\d*(?:\s+\w+)*?\s+opgeschor' # wordt ... opgelegd
    ),
    'verminderen': (
        r'\bverminderd\d*\b' 
        r'|\bvermindert\d*\b'
    ...
    'invorderen': (
        ...
        r'|\bword(?:t)\d*(?:\s+\w+)*?\s+ingevorder' # wordt ... opgelegd
    ),
    'geven': (
        r'\bgeef(?:t)\b'
        r'|\bgeven\b'
        r'|\bword(?:t)\d*(?:\s+\w+)*?\s+gegeven' # wordt ... opgelegd
    ),
    'bindend_verklaren': (
        r'\bverklaar(?:t)\b(?:\s+\w+)*?\s+bindend\d*\b'
        r'|\bverklaar(?:d)\b(?:\s+\w+)*?\s+bindend\d*\b'
        r'|\bword(?:t)\d*(?:\s+\w+)*?\s+bindend\b(?:\s+\w+)*?\s+verklaa' # wordt ... opgelegd
    )
}

# Which actions are relevant for each rechtsobject
object_action_map = {
